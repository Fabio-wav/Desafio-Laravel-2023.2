<div class="row">
    ...
    <div class="form-group col-sm-12 col-md-4">
        ...
        <input type="text" name="raca" id="raca" class="form-control" value="{{ old('telefone', $animal->raca ?? '') }}">
    </div>
    <div class="form-group col-sm-12 col-md-4">
        <label for="tratamentosRealizados">Tratamentos Realizados</label>
        <input type="text" name="tratamentosRealizados" id="tratamentosRealizados" class="form-control" value="{{ old('tratamentosRealizados', $animal->telefone ?? '') }}">
    </div>
    <div class="col-md-4">
